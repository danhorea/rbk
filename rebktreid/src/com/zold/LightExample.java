...
public class LightExample extends Application {
	...
	private static class View {
		...
		private View(Model model) {
			...
			HBox hbox1 = new HBox(10, new Label("Red light x:"), redLightXSlider, new Label("y:"), redLightYSlider,
			...
			HBox hbox2 = new HBox(10, new Label("Blue light x:"), blueLightXSlider, new Label("y:"), blueLightYSlider,
