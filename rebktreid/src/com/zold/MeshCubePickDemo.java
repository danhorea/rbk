...
public class MeshCubePickDemo extends Application {
	...
	public void start(Stage stage) {
		...
		Image diffuseMap = new Image(MeshCubePickDemo.class.getResource("cbGn_pof-bm.png").toExternalForm());
		...
		Rotate xRotate;
		Rotate yRotate;
		parent.getTransforms().setAll(xRotate = new Rotate(0, Rotate.X_AXIS), yRotate = new Rotate(0, Rotate.Y_AXIS));
		...
		scene.setOnMousePressed((MouseEvent event) -> {
			...
			facePickedLabel.setText("Face picked: " + pr.getIntersectedFace());
		});
		...
		HBox subSceneGroup = new HBox(70, new HBox(10, zLabel, zSlider), meshCheckBox, facePickedLabel);
